...
import { remedyCategories } from "@/lib/remedies-data";
        ...
        <div className="container mx-auto px-4 relative z-10 py-16">
          ...
          >
            ...
            <p className="text-lg text-background/70 mt-4 max-w-lg leading-relaxed">
              Discover time-tested Ayurvedic remedies curated by expert
              specialists. Save, share, and download your favorites.
            </p>
            <div className="flex flex-wrap gap-4 mt-6">
              <Link to="/products">
                <Button size="lg" className="gap-2">
                  Shop Herbs <ArrowRight className="h-4 w-4" />
                </Button>
              </Link>
              <Link to="/specialists">
                <Button
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mt-20 text-center bg-gradient-to-r from-primary/10 via-secondary to-primary/10 rounded-2xl p-12">
          <h2 className="text-2xl lg:text-3xl font-display font-bold mb-3">
            Need Personalized Remedies?
          </h2>
          <p className="text-muted-foreground mb-6 max-w-lg mx-auto">
            Consult our Ayurvedic specialists for remedies tailored to your
            unique body constitution (Prakriti).
          </p>
          <Link to="/contact">
            <Button size="lg" className="gap-2">
